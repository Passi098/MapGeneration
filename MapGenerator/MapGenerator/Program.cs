...
namespace MapGenerator
{
    class Program
    {
        ...
        public static void DrawPerlin(PerlinNoise _perlin, string _filename)
        {
            PNG image = new PNG(_perlin.m_Detail, _perlin.m_Detail, Color.White);
            image = new PNG(Environment.CurrentDirectory + @"\green.png");
        ...
        //public static void DrawVoronoi(VoronoiDiagramm _voronoi)
        //{
        //    PNG image = new PNG(_voronoi.SizeX, _voronoi.SizeY);
        //    image.Clear(Color.White);

        //    DrawFaces(_voronoi, image);
        //    DrawTriangulation(_voronoi, image);
        //    DrawEdges(_voronoi, image);
        //    DrawDots(_voronoi, image);
        //    image.Save(Environment.CurrentDirectory + @"\" + "Voronoi" + ".png");
        //    image.Dispose();
        //}

        //public static void DrawDots(VoronoiDiagramm _voronoi, PNG _image)
        //{
        //    foreach (Voronoi.Dot dot in _voronoi.m_Dots)
        //    {
        //        _image[dot.m_Pos.x, dot.m_Pos.y] = Color.Orange;
        //    }
        //}

        //public static void DrawTriangulation(VoronoiDiagramm _voronoi, PNG _image)
        //{
        //    foreach (Voronoi.Dot dot in _voronoi.m_Dots)
        //    {
        //        foreach (Voronoi.Dot other in dot.m_Neighbors)
        //        {
        //            if (other.m_Index != -1)
        //            {
        //                _image.DrawLine(Color.Black, dot.m_Pos.x, dot.m_Pos.y, other.m_Pos.x, other.m_Pos.y);
        //            }
        //        }
        //    }
        //}

        //public static void DrawEdges(VoronoiDiagramm _voronoi, PNG _image)
        //{
        //    foreach (Voronoi.Dot dot in _voronoi.m_Dots)
        //    {
        //        foreach (Voronoi.Centroid cent in dot.m_Centroids)
        //        {
        //            foreach (Voronoi.Edge edge in cent.m_Neigbors)
        //            {
        //                _image.DrawLine(Color.Orange, cent.m_Pos.x, cent.m_Pos.y, edge.m_Other.m_Pos.x, edge.m_Other.m_Pos.y);
        //            }
        //        }
        //    }
        //}

        //public static void DrawFaces(VoronoiDiagramm _voronoi, PNG _image)
        //{
        //    for (int x = 0; x < _voronoi.SizeX; x++)
        //    {
        //        for (int y = 0; y < _voronoi.SizeY; y++)
        //        {
        //            int color = 100 + (int)(155 * (_voronoi[x, y] / (float)_voronoi.m_Dots.Length));
        //            _image[x, y] = Color.FromArgb(255, 0, color, 0);
        //        }
        //    }
        //}
    ...
    //        m_TopEdge.CalcHeight(0);
    //        m_BottomEdge.CalcHeight(0);
    //        m_LeftEdge.CalcHeight(0);
    //        m_RightEdge.CalcHeight(0);
    ...
    //        public List<Dot> m_Neighbors = new List<Dot>();
    ...
    //        public override void CalcHeight(int _height)
    //        {
    //            foreach (Dot dot in m_Neighbors)
    //            {
    //                dot.CalcHeight(0);
